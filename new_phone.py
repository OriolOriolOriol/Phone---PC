...
def avvio_git(commit):
    os.chdir("C:\\Users\\claud\\Desktop\\Ricordi\\")
    passo1=f"git init"
    os.system(passo1)
...
def main():
    ...
    if option == '1':
        ...
        place_location="C:\\Users\\claud\\Desktop\\Ricordi\\" + nome
        ...
        place_location="C:\\Users\\claud\\Desktop\\Ricordi\\" + nome1
        os.system("adb -s "+device_name+" pull "+file_location+" "+ place_location)
        print("Finito\n")
        t.sleep(1)
        main()
    ...
    #da controllare
        ...
        dir="start" + " " + "C:\\Users\\claud\\Desktop\\PROGETTO_PERSONALE\\\KIRA\\PROGETTO_KIRA\\phone\\adb\\adb" + " "
